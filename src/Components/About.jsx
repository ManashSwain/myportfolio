const About = () => {
  return (
   ...
   When I’m not coding, I enjoy exploring new technologies, working on personal projects, and sharing my knowledge with others. I’m always eager to learn and grow as a developer, embracing challenges as opportunities to innovate and improve.

   Feel free to explore my portfolio to see my skills, projects, and experience in action. Let’s connect and create something amazing together! 🚀
   </h3>
   </>
  )
}
