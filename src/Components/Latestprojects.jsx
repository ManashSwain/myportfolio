  ...
  return (
    <>
      <div className="text-center my-12">
        ...
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl my-2">Check out my latest work</h2>
        <p className="my-2text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">I have worked on a variety of projects, from simple websites to complex web applications. Here are a few of my favorites.</p>
      </div>
      
      <div className="best-projects flex flex-row justify-center gap-6">
  {/* Project Card 1 */}
  <div className="max-w-sm w-[50%] bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
    ...
    <div className="p-6">
      ...
      <p className="text-sm text-gray-600 mt-4">
        ...
        which allows users to collect email addresses from their GPT users. This
        is a great way to build an audience and monetize your GPT API usage.
      </p>
